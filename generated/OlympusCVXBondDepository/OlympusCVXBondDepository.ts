...
export class OlympusCVXBondDepository__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OlympusCVXBondDepository__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OlympusCVXBondDepository__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OlympusCVXBondDepository extends ethereum.SmartContract {
  static bind(address: Address): OlympusCVXBondDepository {
    return new OlympusCVXBondDepository("OlympusCVXBondDepository", address);
  }
  ...
  adjustment(): OlympusCVXBondDepository__adjustmentResult {
    ...
    return new OlympusCVXBondDepository__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<
    OlympusCVXBondDepository__adjustmentResult
  > {
    ...
    return ethereum.CallResult.fromValue(
      new OlympusCVXBondDepository__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): OlympusCVXBondDepository__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new OlympusCVXBondDepository__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<OlympusCVXBondDepository__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusCVXBondDepository__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  principal(): Address {
    let result = super.call("principal", "principal():(address)", []);

    return result[0].toAddress();
  }

  try_principal(): ethereum.CallResult<Address> {
    let result = super.tryCall("principal", "principal():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  terms(): OlympusCVXBondDepository__termsResult {
    let result = super.call(
      "terms",
    ...
    return new OlympusCVXBondDepository__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<OlympusCVXBondDepository__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusCVXBondDepository__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
